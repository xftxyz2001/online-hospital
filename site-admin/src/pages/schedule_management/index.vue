      ...
      <el-table :data="tableData" style="width: 1100px" :header-cell-style="{ background: '#ECF3FE' }">
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template #default="scope">
            <el-button type="primary" size="small" @click="scheduleClick(scope.row.id)">排班</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
...
const scheduleClick = id => {
  store.commit("changeScheduleHospitalId", id);
  router.push("/home/schedulemanagement");
};
</script>
