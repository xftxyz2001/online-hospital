  ...
  <div class="container">
    ...
    <div class="content">
      <div class="table">
        ...
        >
          <el-table-column fixed prop="username" label="就诊人" width="200">
          ...
          <el-table-column prop="username" label="院区" width="200">
            <template #default="scope">
              <div style="display: flex; align-items: center">
          ...
          <el-table-column prop="username" label="门诊" width="200">
            <template #default="scope">
              <div style="display: flex; align-items: center">
          ...
          <el-table-column prop="username" label="医生" width="200">
            <template #default="scope">
              <div style="display: flex; align-items: center">
          ...
          <el-table-column prop="phone" label="预约号" width="280">
            <template #default="scope">
              <div style="display: flex; align-items: center">
...
import { queryRegistrationInfo } from "@/api/hospital/schedule";
//当前页
